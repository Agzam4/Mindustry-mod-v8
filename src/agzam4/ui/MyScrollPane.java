...
public class MyScrollPane extends WidgetGroup{
    ...
    /** @param widget May be null. */
    public MyScrollPane(Element widget, ScrollPaneStyle style){
...
//                cancel();
        ...
        addCaptureListener(new InputListener(){
            ...
            @Override
            public boolean touchDown(InputEvent event, float x, float y, int pointer, KeyCode button){
                Element actor = MyScrollPane.this.hit(x, y, true);
                on = flickScroll;
                if((actor instanceof Slider || actor instanceof TextField) && on){
                	MyScrollPane.this.setFlickScroll(false);
                    return true;
                }
            ...
            public void touchUp(InputEvent event, float x, float y, int pointer, KeyCode button){
                if(on){
                	MyScrollPane.this.setFlickScroll(true);
                }
