...
public enum MyEditorTool {
	...
	pen {
		...
		@Override
		public boolean line(MyMapEditor editor, float x1, float y1, float x2, float y2) {
			if(Core.input.keyDown(KeyCode.mouseLeft)) {
				Bresenham2.line((int)x1,(int)y1,(int)x2,(int)y2, (x,y) -> {
					editor.drawAt(x, y);
				});
				return true;
...
//	public void act(MyMapView view, float delta) {
//		if()
//	}
	public boolean line(MyMapEditor editor, float x1, float y1, float x2, float y2) {
		return false;
...
//    };
//
//	public static MyMapEditor editor = MyMapEditor.instance;
//	
