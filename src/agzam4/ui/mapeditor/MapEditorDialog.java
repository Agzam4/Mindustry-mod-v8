...
public class MapEditorDialog extends Dialog implements Disposable {
	...
	public static MapEditorDialog instance = new MapEditorDialog();
	
	private MyMapView view = new MyMapView();

	mindustry.editor.MapEditorDialog debug;
...
//
//	public static final MapEditorDialog instance = new MapEditorDialog();
//	public MyMapEditor editor = MyMapEditor.instance;
//	public MyMapView view;
//    
...
//        lastSavedRules = null;
//        saved = false;
////        editor.renderer.updateAll(); TODO
//    }
//
