...
public class Code {
	...
	public void read(String var, String link, int index) {
		line(Strings.format("read @ @ @", var, link, index));
	}

	public void write(Object var, String link, int index) {
		line(Strings.format("write @ @ @", var, link, index));
	}
